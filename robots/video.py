...
from robots.state import load_content, save_script
import subprocess
...
class Video:
    ...
    def resize_images(self):
        ...
        for index in range(0, self.total_sentences):
            command = f"magick content/{index}-original.png\
                -resize 1920x1080 \
                content/{index}-original.png"
    ...
    def compose_images(self):
        ...
        for index in range(0,self.total_sentences):
            with Image(filename=f'content/{index}-original.png') as img:
                with img.clone() as background:
                    ...
                    with Image(width=background.width, height=background.height) as imgcompose:
                        ...
                        imgcompose.save(filename=f'content/{index}-converted.png')
    ...
    @staticmethod
    def create_after_effects_script():
        save_script()
    ...
    def start_robot(self):
        ...
        self.create_after_effects_script()
